...
public extension UITableView {
     ...
     */
    public func scrollToIndexPathWithDelay(_ delay:Double, indexPath: IndexPath, scrollPosition: UITableView.ScrollPosition, animated: Bool) {
     ...
     * :param   animated Used to define if the action should be animated
     */
    public func scrollToIndexPath(_ indexPath: IndexPath, scrollPosition: UITableView.ScrollPosition, animated: Bool) {
...
extension UITableView: FetchRequestDelegate {
    ...
    public func scroll(at indexPath: IndexPath){
        self.scrollToRow(at: indexPath, at: UITableView.ScrollPosition.middle, animated: true)
    }
}
