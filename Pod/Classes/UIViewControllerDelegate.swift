...
*/
public protocol UIViewControllerDelegate: NSObjectProtocol {
    /**
     ...
     */
    func shouldDismissViewController(_ viewController: UIViewController, animated flag: Bool, completion: (() -> Void)?)
    ...
    /**
     ...
     - parameter completion:     Called after the operation was completed
     */
    func shouldPresentViewController(_ viewController: UIViewController, animated flag: Bool, completion: (() -> Void)?)
    ...
    /**
     ...
     - parameter flag:           Tells if the operation should be animated
     */
    func shouldPushViewController(_ viewController: UIViewController, animated flag: Bool)
}
