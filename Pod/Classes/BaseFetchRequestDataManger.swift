...
open class FetchRequestDataManger: NSObject {
...
extension FetchRequestDataManger: NSFetchedResultsControllerDelegate {
 ...
 */
public protocol FetchRequestDelegate: class {
 ...
 */
public protocol ListPositionDelegate: FetchRequestDelegate {
